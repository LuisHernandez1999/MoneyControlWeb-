...
const ResetPassword = () => {
  ...
  const buildResetPasswordConfirmUrl = (email) => {
    // Replace with your actual logic to build the reset password URL
    return `https://example.com/reset-password?email=${email}`
  }
    ...
    <>
      ...
      <Box
        sx={{
          ...
          alignItems: "center",
          backgroundColor: "#1E90FF", // Azul como background
          zIndex: 1,
        }}
      >
        <Box
        ...
        >
          ...
          <Typography
            ...
            sx={{
              ...
              fontWeight: "bold",
              fontSize: "35px",
              color: "#1E90FF", // Cor azul para o título
            }}
          >
            Controle Financeiro
          </Typography>
